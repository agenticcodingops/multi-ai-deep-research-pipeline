# Kickoff — Billing platform notification rework
...
```json
{
  ...
  "invocation": {
    ...
    "brownfield_repo": "repos/billing-platform",
    "requirements_input_id": "IN1"
  },
  "project": {
    "title": "Billing platform notification rework",
    "research_question": "What architecture should the team notification service use?",
    "decision_context": "Feed the ADR into Spec Kit for the build.",
    ...
    "constraints": [
      "Must run on the existing Azure estate"
    ],
    "stakes": "medium",
    ...
    "classified_inputs": [
      {
        "input_id": "IN1",
        "path": "docs/requirements v2 — draft.md",
        "trust": "under_scrutiny",
        "contaminants": [
          "the $40k budget anchor"
        ]
      }
    ],
    "ground_truth": [],
    "topic_slug": "billing-platform-notifications",
    "allowed_verdicts": []
  },
  "deliberation_modes": [],
  "use_case_profile": {
  ...
  "provenance": {
    ...
    "/use_case_profile/product_target_users": "explicit",
    "/use_case_profile/requirements_coverage": "explicit",
...
billing-platform-notifications
