# Kickoff — Adopt the pipeline company-wide?
...
```json
{
  ...
  "project": {
    "title": "Adopt the pipeline company-wide?",
    ...
    "constraints": [
      "Decision needed before the board meeting"
    ],
    "stakes": "medium",
    "confidentiality": "non_confidential",
    "classified_inputs": [],
    "ground_truth": [],
    "topic_slug": "adopt-pipeline-company-wide",
    "allowed_verdicts": [
      "GO",
      "NO-GO",
      "GO-WITH-CONDITIONS"
