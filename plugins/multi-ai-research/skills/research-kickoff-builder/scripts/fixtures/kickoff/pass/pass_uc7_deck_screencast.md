# Kickoff — Multi-agent pipelines deck and screencast
...
```json
{
  ...
  "project": {
    "title": "Multi-agent pipelines deck and screencast",
    "research_question": "How should teams adopt multi-agent research pipelines?",
    "decision_context": "One Marp source rendering a deck and a screencast.",
    "time_horizon": "Within two weeks; evidence from the last 18 months.",
    "audience": "Senior engineers evaluating the options",
    "thesis": "One source of truth beats parallel deck and script maintenance.",
    "differentiation_hook": "Nobody shows the single-source Marp + Descript workflow end-to-end.",
    "constraints": [],
    "stakes": "medium",
    "confidentiality": "non_confidential",
    "classified_inputs": [],
    "ground_truth": [],
    "topic_slug": "multi-agent-pipelines-deck-screencast",
    "allowed_verdicts": []
  },
  "deliberation_modes": [],
  "use_case_profile": {
    "deck_slide_target": 33,
  ...
  "provenance": {
    ...
    "/use_case_profile/deck_slide_target": "explicit",
