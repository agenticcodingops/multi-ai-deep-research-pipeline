# Kickoff — Internal platform architecture decision
...
```json
{
  ...
  "project": {
    "title": "Internal platform architecture decision",
    ...
    "classified_inputs": [],
    "ground_truth": [],
    "topic_slug": "internal-platform-architecture",
    "allowed_verdicts": []
  },
  "deliberation_modes": [],
  "use_case_profile": {
