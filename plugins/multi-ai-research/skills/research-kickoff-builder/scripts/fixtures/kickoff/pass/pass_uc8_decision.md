# Kickoff — Buy or self-host the research stack?
...
```json
{
  ...
  "project": {
    "title": "Buy or self-host the research stack?",
    "research_question": "Should we buy the managed research stack or self-host the open-source version?",
    "decision_context": "Make the go/no-go platform decision for next quarter.",
    ...
    "classified_inputs": [],
    "ground_truth": [],
    "topic_slug": "buy-or-self-host-research-stack",
    "allowed_verdicts": [
      "GO",
      "NO-GO",
      "GO-WITH-CONDITIONS"
  ...
  "use_case_profile": {
    ...
    "reversibility": "Two-way door for six months, then data gravity makes it one-way.",
  ...
  "provenance": {
    ...
    "/use_case_profile/current_leaning": "explicit",
    "/use_case_profile/decision_options": "explicit",
    "/use_case_profile/reversibility": "explicit",
