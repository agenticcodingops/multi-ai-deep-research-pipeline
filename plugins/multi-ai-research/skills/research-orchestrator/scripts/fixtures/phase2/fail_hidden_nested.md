...
<div style="display:none">supplementary reference dump kept out of sight
<span style="display:none">[^1]: https://example.org/ref/nested-note-one
[^2]: https://example.org/ref/nested-note-two</span>
[^3]: https://example.org/ref/nested-note-three</div>
