...
<!-- reference dump held back from the visible answer: https://example.org/ref/comment-note-one plus https://example.org/ref/comment-note-two and roughly sixty additional characters of citation annotations -->
