...
The image-pipeline generator remains the right choice for a hobby photography blog, and nothing in the opposing case overturns that conclusion. The opposing argument is strongest on raw rebuild speed and weakest on the day-to-day workflow a photographer actually runs, which is where this project will live or die. [REASONED]
